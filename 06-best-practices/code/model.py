...
mlflow.set_tracking_uri("file:///var/task/mlruns")
...
def get_model_location(run_id):
    ...
    model_bucket = os.getenv('MODEL_BUCKET','mlartifacts')
    experiment_id = os.getenv('EXPERIMENT_ID', '1')

    model_location = f"/var/task/{model_bucket}/{experiment_id}/{run_id}/artifacts/model"
    return model_location
