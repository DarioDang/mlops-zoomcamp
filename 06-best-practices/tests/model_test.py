...
def test_prepare_features():
    "Write a function to prepare feature"
...
# Define the mock model for testing
class ModelMock:
    ...
    def predict(self, X):
        n =  len(X)
        return [self.value] * n # Make sure I have predict result for all of the prediction
